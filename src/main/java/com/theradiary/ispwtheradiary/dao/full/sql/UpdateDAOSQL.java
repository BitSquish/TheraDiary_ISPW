...
import com.theradiary.ispwtheradiary.query.LoginAndRegistrationQuery;
import com.theradiary.ispwtheradiary.query.UpdateQuery;
...
public class UpdateDAOSQL implements UpdateDAO {
    ...
    public void deleteMedicalOffice(MedicalOffice medicalOffice) {
        try(Connection conn = ConnectionFactory.getConnection()){
            UpdateQuery.deleteMedicalOffice(conn, medicalOffice.getPsychologist());
        }catch (SQLException | DatabaseOperationException e){
            handleException(e);
        }
    }
