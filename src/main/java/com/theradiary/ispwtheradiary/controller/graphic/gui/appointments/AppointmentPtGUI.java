package com.theradiary.ispwtheradiary.controller.graphic.gui.appointments;
import com.theradiary.ispwtheradiary.controller.application.AppointmentPtController;
        ...
        if(psychologistBean != null && psychologistBean.getCredentialsBean().getMail() != null) {
            ...
            if(allAppointments.isEmpty()){
                ...
                if(appointmentBean != null){
                    emptyAppointments.setVisible(true);
                    errorMessage.setText("Hai già un appuntamento fissato con lo psicologo, ogni " + DayOfTheWeek.translateDay(appointmentBean.getDay().getId()) + " nella fascia oraria " + TimeSlot.translateTimeSlot(appointmentBean.getTimeSlot().getId()) + " in " + (appointmentBean.isInPerson() ? "presenza" : "online"));
