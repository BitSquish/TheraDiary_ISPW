...
import com.theradiary.ispwtheradiary.controller.application.TaskAndToDoPsController;
...
public class TaskAndToDoPsGUI extends CommonGUI {

    private final TaskAndToDoPsController taskAndToDoController = new TaskAndToDoPsController();
    public TaskAndToDoPsGUI(FXMLPathConfig fxmlPathConfig, Session session) {
    ...
    public void saveTask(MouseEvent event) {
        for (TaskBean task : listTask) {
            taskAndToDoController.saveTask(patientBean, task);
        }
